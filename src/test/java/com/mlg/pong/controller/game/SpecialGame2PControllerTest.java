...
class SpecialGame2PControllerTest {
    ...
    public void test_initialize_controllers() {
        SpecialGame2PController controller = new SpecialGame2PController(game);
    ...
    public void test_handle_player_movement() throws IOException {
        SpecialGame2PController controller = Mockito.mock(SpecialGame2PController.class);
